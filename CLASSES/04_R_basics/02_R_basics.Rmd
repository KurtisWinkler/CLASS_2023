...
kurt_peak1 <- read_tsv(file.path(kurt_basepath,
"CLASS_2023/group_chip/kurt/results/bwa/mergedLibrary/macs/broadPeak/BRCA1_R1_peaks.broadPeak"), col_names=FALSE)
...
names(kurt_peak1) <- c('chromosome', 'start', 'end', 'name', 'score', 'strand', 
                       'signalValue', 'pValue', 'qValue')
...
density <- density(kurt_peak1$peak_width)
...
kurt_peak1 <- read_tsv(file.path(kurt_basepath,
"CLASS_2023/group_chip/kurt/results/bwa/mergedLibrary/macs/broadPeak/BRCA1_R3_peaks.broadPeak"), col_names=FALSE)

kurt_peak1 <- read_tsv("/scratch/Shares/rinnclass/CLASS_2023/JR/CLASS_2023/CLASSES/03_Nextflow/00_Pol2_NF_CORE_RUN/results/bwa/mergedLibrary/macs/broadPeak/POLR2A_R1_peaks.broadPeak", col_names = F)

names(kurt_peak1) <- c('chromosome', 'start', 'end', 'name', 'score', 'strand', 
                       'signalValue', 'pValue', 'qValue')

kurt_peak1 <- kurt_peak1[kurt_peak1$chromosome %in% c(paste0("chr", 1:22), "chrM", "chrX", "chrY"),]

kurt_peak1 <- kurt_peak1 %>% mutate(peak_width = end - start)
