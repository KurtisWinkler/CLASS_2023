...
setwd("/scratch/Shares/rinnclass/CLASS_2023/kurt/CLASS_2023/CLASSES/05_R_analyses/03_clustering")
# loading in promoter peak occurence and convert to matrix
```{r loading in promoter_peak_occurence_df}
...
pdf("figures/dbp_hclust_dendro.pdf", height = 12, width = 30)
plot(bin_hier)
dev.off()
...
# let's, find the promoters that bind to many of our dbps
# a bit of trial and error but 5 of 7 dbps works for me.
high_binders <- promoter_peak_occurence_matrix[,colSums(promoter_peak_occurence_matrix) > 3] #5
