...
install.packages("https://cran.r-project.org/src/contrib/Archive/interp/interp_1.0-33.tar.gz", repos=NULL, type="source")
install.packages("latticeExtra")
install.packages("https://cran.r-project.org/src/contrib/Archive/Hmisc/Hmisc_4.7-0.tar.gz", repos=NULL, type="source")
