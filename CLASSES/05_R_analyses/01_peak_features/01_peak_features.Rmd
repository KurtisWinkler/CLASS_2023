...
#CLASS_CODE
setwd("/scratch/Shares/rinnclass/CLASS_2023/kurt/CLASS_2023/CLASSES/05_R_analyses/01_peak_features")
...
# adding DBP name to each list of GRanges from the file name
# note gsub requires no space around or argument ( | )
names(consensus_peaks) <- gsub("/scratch/Shares/rinnclass/CLASS_2023/kurt/CLASS_2023/CLASSES/05_R_analyses/00_consensus_peaks/consensus_peaks/|_consensus.bed","", consensus_peaks_files)

### CREATING ANNOTATION FILES FOR FUTURE USE
...
# both mRNA and lncRNA annotations together.
mrna_lncrna_genes <- gencode_genes[gencode_genes$gene_type %in% c("protein_coding","lncRNA")]
rtracklayer::export(mrna_lncrna_genes,
"results/gene_annotations/mrna_lncrna_genes.gtf")
...
source("/scratch/Shares/rinnclass/CLASS_2023/kurt/CLASS_2023/util/my_class_functions.R")
# count_peaks_per_feature function to find overlaps
