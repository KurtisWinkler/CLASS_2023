...
# installing ggpubr
install.packages("https://cran.r-project.org/src/contrib/Archive/nloptr/nloptr_1.2.2.2.tar.gz", repos=NULL, type="source")
...
library(ggpubr)
setwd("/scratch/Shares/rinnclass/CLASS_2023/kurt/CLASS_2023/CLASSES/05_R_analyses/06_Chip_binding_vs_expression_output")
```
