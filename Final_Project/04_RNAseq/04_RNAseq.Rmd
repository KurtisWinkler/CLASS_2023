...
setwd("/scratch/Shares/rinnclass/CLASS_2023/kurt/Final_Project/04_RNAseq")
...
samplesheet$condition <- relevel(dds$condition, 2)
```
...
# make heat map
pdf("figures/nuc_vs_cyto_heatmap.pdf")
...
ggsave("figures/Expression_vs_DBP_promoter_binding.pdf")
