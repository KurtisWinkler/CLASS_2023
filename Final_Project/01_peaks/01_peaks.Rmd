...
setwd("/scratch/Shares/rinnclass/CLASS_2023/kurt/CLASS_2023/Final_Project/01_peaks")
...
save(filtered_consensus_list, gencode_genes, lncrna_gene_ids, mrna_gene_ids, num_peaks_df, peak_occurence_df, 
     file = "results/peak_features.RData")

save(lncrna_mrna_promoters, mrna_lncrna_genes, human_tfs_full, file = "results/peak_features2.RData")
...
ggsave("figures/peak_number_vs_coverage.png")
...
ggsave("figures/peak_distribution.png")
