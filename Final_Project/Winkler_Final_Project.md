...
knitr::include_graphics("01_peaks/figures/peak_number_vs_coverage.png")
```

<img src="01_peaks/figures/peak_number_vs_coverage.png" width="2187" />

``` r
# What is the distribution of promoter overlaps versus gene-bodies (hint hist)
knitr::include_graphics("01_peaks/figures/peak_distribution.png")
```

<img src="01_peaks/figures/peak_distribution.png" width="2187" />
...
There is a larger distribution of peaks overlapping gene bodies compared
to promoters

Super-binders are more associated with mRNAs

I found 9,177 mRNA superbinding promoters and 2512 lncRNA
super-promoters
...
ZNF280B appears to be similar to gene NRL and may be involved in
photoreceptor development/function
...
H3K4me1, H3K4me2, H3K79me2, H4K20me1, and EZH2 bind differently on
lncRNA and mRNA promoters

DBPs on super-binders tend to be more distributed than on regular
promoters
...
in 04\_RNAseq/results/reservoirs.csv I have all the super binders that
don’t express RNA
